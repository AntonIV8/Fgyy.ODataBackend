...
CREATE INDEX service_order_Imodifier_id on [service_order] ([modifier_id])
 ...
 ALTER TABLE [service_order] ADD CONSTRAINT [service_order_Forder_state_1] FOREIGN KEY ([state_m0]) REFERENCES [order_state]
...
CREATE INDEX resource_Iresource_shared_id_m0 on [resource] ([resource_shared_id_m0])
 ...
 ALTER TABLE [resource] ADD CONSTRAINT [resource_Fservice_0] FOREIGN KEY ([parent_service_id]) REFERENCES [service]
...
CREATE INDEX user_group_Igroup_id on [user_group] ([group_id])
 ...
 ALTER TABLE [service] ADD CONSTRAINT [service_Fservice_0] FOREIGN KEY ([cfs_id]) REFERENCES [service]
...
CREATE INDEX service_Istate_m0 on [service] ([state_m0])
 ...
 ALTER TABLE [order_item] ADD CONSTRAINT [order_item_Fservice_0] FOREIGN KEY ([service_id]) REFERENCES [service]
...
CREATE INDEX order_item_Istate on [order_item] ([state])
 ...
 ALTER TABLE [order_item] ADD CONSTRAINT [order_item_Fservice_1] FOREIGN KEY ([clone_service_id]) REFERENCES [service]
...
CREATE INDEX order_item_Icreator_id_m0 on [order_item] ([creator_id_m0])
 ...
 ALTER TABLE [order_item] ADD CONSTRAINT [order_item_Fservice_3] FOREIGN KEY ([clone_service_id_m0]) REFERENCES [service]
...
CREATE INDEX resource_spec_characteristic_Idictionary_id on [resource_spec_characteristic] ([dictionary_id])
 ...
 ALTER TABLE [resource_spec_characteristic] ADD CONSTRAINT [resource_spec_characteristic_Fresource_spec_1] FOREIGN KEY ([resource_spec_id_m0]) REFERENCES [resource_spec]
